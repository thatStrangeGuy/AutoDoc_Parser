...
################################################################################
## Form generated from reading UI file 'database_record_ui.ui'
##
...
"")
        ...
        self.databaseRecordUpperOrder_Button_2 = QPushButton(self.frame_2)
        self.databaseRecordUpperOrder_Button_2.setObjectName(u"databaseRecordUpperOrder_Button_2")
        icon2 = QIcon()
        icon2.addFile(u":/file_open/icons/icons8-up-90.png", QSize(), QIcon.Normal, QIcon.Off)
        self.databaseRecordUpperOrder_Button_2.setIcon(icon2)

        self.verticalLayout_5.addWidget(self.databaseRecordUpperOrder_Button_2)

        self.databaseRecordDownOrder_Button_2 = QPushButton(self.frame_2)
        self.databaseRecordDownOrder_Button_2.setObjectName(u"databaseRecordDownOrder_Button_2")
        icon3 = QIcon()
        icon3.addFile(u":/file_open/icons/icons8-down-90.png", QSize(), QIcon.Normal, QIcon.Off)
        self.databaseRecordDownOrder_Button_2.setIcon(icon3)

        self.verticalLayout_5.addWidget(self.databaseRecordDownOrder_Button_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.databaseRecordUpperOrder_Button_2.setText("")
        self.databaseRecordDownOrder_Button_2.setText("")
    # retranslateUi
